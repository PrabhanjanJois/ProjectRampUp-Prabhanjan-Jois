...
import TestingSkills from "../../components/settingsComp/empTypeTable1";
  ...
  const CallApi = async () => {
    ...
    try {
      const response = axios.get(
        "https://tranquil-hamlet-54124.herokuapp.com/employee_types/all",
        payload
      );
        ...
        <>
          <div>
            ...
            <div className={styles.mainDiv}>
              ...
              <button
                className={styles.addSetProjBtn2}
                style={{ color: "white" }}
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)}>
              <div>
                ...
                <h6 className={styles2.modalName}>EMPLOYEE TYPE NAME</h6>
                <input
                ...
                />
                <h6 className={styles2.modalName2}>
                ...
                />
                <h6 className={styles2.modalName3}>EMPLOYEE TYPE STATUS</h6>
