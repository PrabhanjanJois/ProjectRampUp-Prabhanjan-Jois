...
import TestingSkills from "../../components/settingsComp/projTypeTable1";
...
const testing1 = () => {
  ...
  const CallApi = async () => {
    ...
    try {
      const response = axios.get(
        "https://tranquil-hamlet-54124.herokuapp.com/project_types/all",
        payload
      );
  ...
  //
  const [mName, setMname] = useState<string>("newNgggg");
  ...
  async function handleSubmit1(e: any) {
    ...
    await axios
      .post(
        "https://tranquil-hamlet-54124.herokuapp.com/project_type",
        formData,
        headers
      )
        ...
        <>
          <div>
            ...
            <div className={styles.mainDiv}>
              ...
              <button
                className={styles.addSetProjBtn}
                style={{ color: "white" }}
